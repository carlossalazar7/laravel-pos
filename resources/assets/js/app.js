...
Vue.component('product-inventory', require('./components/products/inventory/ProductInventory.vue'));
...
Vue.component('after-done-payment-thermal-invoice', require('./components/salesOrReceives/invoice/ThermalAfterDonePaymentInvoice.vue'));
Vue.component('print-receipt-component', require('./components/salesOrReceives/invoice/PrePrintReceipt.vue'));
Vue.component('thermal-pre-print-receipt', require('./components/salesOrReceives/invoice/ThermalPreprintReceipt.vue'));
...
Vue.component('basic-invoice-template', require('./components/settings/invoiceTemplates/BasicTemplate.vue'));
Vue.component('thermal-invoice-template', require('./components/settings/invoiceTemplates/ThermalTemplate.vue'));
...
Vue.component('close-guide-modal', require('./components/guides/CloseGuideModal.vue'));
