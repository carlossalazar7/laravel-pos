<template>
  <div class="action-button-wrapper">
    <div class='action-button-container'>
      ...
      <a href="" class='action-button' data-toggle="modal" data-target="#delivery-add-edit-modal"
         @click.prevent="deliveryAddEdit(rowData.id)"><i class="la la-edit la-2x"></i></a>
    </div>
...
export default {
  ...
  methods: {
    deliveryAddEdit(id) {
      this.$hub.$emit('deliveryAddEdit', id);
    },
