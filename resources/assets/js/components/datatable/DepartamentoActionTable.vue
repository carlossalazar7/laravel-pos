<template>
  <div class="action-button-wrapper">
    <div class='action-button-container'>
      ...
      <a href="" class='action-button' data-toggle="modal" data-target="#departamento-add-edit-modal"
         @click.prevent="departamentoAddEdit(rowData.id)"><i class="la la-edit la-2x"></i></a>
    </div>
...
export default {
  ...
  methods: {
    departamentoAddEdit(id) {
      this.$hub.$emit('departamentoAddEdit', id);
    },
