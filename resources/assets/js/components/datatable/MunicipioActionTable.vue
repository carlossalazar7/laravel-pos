<template>
  <div class="action-button-wrapper">
    <div class='action-button-container'>
      ...
      <a href="" class='action-button' data-toggle="modal" data-target="#municipio-add-edit-modal"
         @click.prevent="municipioAddEdit(rowData.id)"><i class="la la-edit la-2x"></i></a>
    </div>
...
export default {
  ...
  methods: {
    municipioAddEdit(id) {
      this.$hub.$emit('municipioAddEdit', id);
    },
