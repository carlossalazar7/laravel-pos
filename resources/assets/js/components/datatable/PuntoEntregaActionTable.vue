<template>
  <div class="action-button-wrapper">
    <div class='action-button-container'>
      ...
      <a href="" class='action-button' data-toggle="modal" data-target="#punto-entrega-add-edit-modal"
         @click.prevent="puntoEntregaAddEdit(rowData.id)"><i
          class="la la-edit la-2x"></i></a>
    </div>
...
export default {
  ...
  methods: {
    puntoEntregaAddEdit(id) {
      this.$hub.$emit('puntoEntregaAddEdit', id);
    },
