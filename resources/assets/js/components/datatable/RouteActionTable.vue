<template>
  <div class="action-button-wrapper">
    <div class='action-button-container'>
      ...
      <a href="" class='action-button' data-toggle="modal" data-target="#route-add-edit-modal"
         @click.prevent="routeAddEdit(rowData.id)"><i class="la la-edit la-2x"></i></a>
    </div>
