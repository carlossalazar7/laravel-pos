            ...
            <div class="main-layout-card-header-with-button">
                <div class="main-layout-card-content-wrapper">
                    ...
                    <div class="main-layout-card-header-contents text-right">
                         <button
                             class="btn btn-secondary app-color"
                             @click.prevent="exportAll('/export/all/report/sales')">
...
import ExportAllMixin from "../products/products/mixins/ExportAllMixin";

export default {
    props: ['permission'],
    extends: axiosGetPost,
    mixins: [ExportAllMixin],
    data() {
        return {
            isActive: false,
