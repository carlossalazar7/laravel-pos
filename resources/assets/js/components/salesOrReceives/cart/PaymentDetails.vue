<template>
    <div class="modal-layout-content">
        ...
        <template v-if="!status.donePaymentCheck">
            <thermal-pre-print-receipt
                v-if="invoice_size === 'thermal'"
        ...
        <template v-else>
            <after-done-payment-thermal-invoice
                v-if="invoice_size === 'thermal'"
                :print-invoice="status.printInvoice"
                :raw-html="rawHtml"
                :invoice-size="invoice_size"
